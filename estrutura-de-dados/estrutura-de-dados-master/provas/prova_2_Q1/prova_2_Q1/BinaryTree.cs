...
namespace prova_2_Q1
{
    class BinaryTree<ADT> : Object
    {
        ...
        /// <summary>
        /// Private method that returns the number of leafs in the tree
        /// </summary>
        /// <param name="root"></param>
        /// <returns></returns>
        private int leafCounter(Node<ADT> root)
        {
            if (root == null)
            {
                return 0;
            ...
            int leftLeafCounter = leafCounter(root.getLeft());
            int rightLeafCounter = leafCounter(root.getRight());
            return leftLeafCounter + rightLeafCounter;
        }
